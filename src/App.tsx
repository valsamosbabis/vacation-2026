  ...
  return (
    <div style={{ maxWidth: '500px', margin: 'auto', padding: '15px', fontFamily: 'system-ui', minHeight: '100vh', background: '#f8fafc' }}>
      ...
      <div style={{ display: 'flex', gap: '5px', marginBottom: '20px' }}>
        <button onClick={() => setTab('map')} style={{...commonStyle.button, flex: 1, background: tab === 'map' ? '#3b82f6' : '#e2e8f0'}}>📍 ΧΑΡΤΗΣ</button>
      </div>

      {tab === 'map' && (
        <div style={{ position: 'relative', height: '500px', borderRadius: '20px', overflow: 'hidden', border: '2px solid #e2e8f0' }}>
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d200547.45265438885!2d25.86729579726563!3d38.36873550000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14a01c4c8d50454b%3A0x8670550c609c9103!2zzqfOrM6-zrnOsQ!5e0!3m2!1sel!2sgr!4v1715783300000!5m2!1sel!2sgr" width="100%" height="100%" style={{ border: 0 }} allowFullScreen loading="lazy"></iframe>
          <button onClick={() => setShowModal(true)} style={{...commonStyle.button, position: 'absolute', bottom: '20px', right: '20px', background: '#3b82f6', color: 'white', borderRadius: '50%', width: '65px', height: '65px', fontSize: '35px', zIndex: 5 }}>+</button>
          
          {showModal && (
            <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', background: 'rgba(0,0,0,0.7)', padding: '20px', zIndex: 9999, display: 'flex', alignItems: 'center' }}>
